...
public class DirectoryMonitor implements Runnable {
        ...
        while (ite.hasNext()) {
            ...
            if (file.exists()) {
                if (file.isFile()) {
                    ...
                    log.error("Error does file exsists ? " + file.exists());
                }
                monitorlist.put(file.getAbsolutePath(), famreq);
            } else {
                log.error(file.getAbsoluteFile()+" which were configure didn't exist");
            }
        }
    ...
    /**
     * Main loop for watching changes on the file system
     */
    public void run() {
    ...
    /**
     * Add a directory to be monitored for changes
     * @param path 
     * @return 
     */
    ...
    /**
     * Removes a directory from the list of files to monitor.
     * This is usually due to a delete.
     * 
     * @param path 
     * @return 
     */
    ...
    /**
     * Get's the next file from the queue that should be indexed.
     * @return The next file in the queue
     */
    ...
    /**
     * Converts a FAM code to text
     * @param code The fam code
     * @return String comparing to the FAM code
     */
